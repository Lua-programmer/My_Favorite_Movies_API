...
const atualizado = "Parabéns, você conseguiu atualizar o filme com sucesso, retorne a página principal para conferir a atualização!";
const excluido = "Você excluiu o filme, retorne a página principal para checar a exclusão";
...
router.put('/:id', (req, res) => {
    ...
    if (!novoFilme || !novoFilme.nome || !novoFilme.genero || !novoFilme.nota || !novoFilme.urlImagem) {
        console.log(400);
        res.status(400).send("Bad request");
        return;
    }
